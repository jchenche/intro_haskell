...
-- visualize: interleaveStreams (streamRepeat 0) (interleaveStreams (streamRepeat 1) (interleaveStreams (streamRepeat 2) (interleaveStreams ...
ruler :: Stream Integer
-- ruler = interleaveStreams (streamRepeat 0) (streamMap (1+) ruler)
ruler = f 0
    where f repeat = interleaveStreams (streamRepeat repeat) (f (repeat+1))
